...
public class FragmentController {
    ...
    @Deprecated
    public C1650SimpleArrayMap<String, LoaderManager> retainLoaderNonConfig() {
        return null;
    }

    @Deprecated
    public void restoreLoaderNonConfig(C1650SimpleArrayMap<String, LoaderManager> simpleArrayMap) {
    }
