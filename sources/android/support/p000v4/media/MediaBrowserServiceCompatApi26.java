...
class MediaBrowserServiceCompatApi26 {
    ...
    static class MediaBrowserServiceAdaptor extends MediaBrowserServiceCompatApi23.MediaBrowserServiceAdaptor {
        ...
        public void onLoadChildren(String parentId, MediaBrowserService.Result<List<MediaBrowser.MediaItem>> result, Bundle bundle) {
            ResultWrapper resultWrapper;
            Bundle options = bundle;
            MediaSessionCompat.ensureClassLoader(options);
            new ResultWrapper(result);
            ((ServiceCompatProxy) this.mServiceProxy).onLoadChildren(parentId, resultWrapper, options);
        }
    }
