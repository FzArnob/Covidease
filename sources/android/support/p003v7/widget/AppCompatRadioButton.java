...
public class AppCompatRadioButton extends RadioButton implements TintableCompoundButton {
    ...
    public AppCompatRadioButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0425R.attr.radioButtonStyle);
    }
    ...
    public AppCompatRadioButton(android.content.Context r10, android.util.AttributeSet r11, int r12) {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.AppCompatRadioButton.<init>(android.content.Context, android.util.AttributeSet, int):void");
    }
