...
class ViewInfoStore {
    ...
    @VisibleForTesting
    final C1642ArrayMap<RecyclerView.ViewHolder, InfoRecord> mLayoutHolderMap;
    @VisibleForTesting
    final C1647LongSparseArray<RecyclerView.ViewHolder> mOldChangedHolders;
    ...
    ViewInfoStore() {
        C1642ArrayMap<RecyclerView.ViewHolder, InfoRecord> arrayMap;
        C1647LongSparseArray<RecyclerView.ViewHolder> longSparseArray;
        new C1642ArrayMap<>();
