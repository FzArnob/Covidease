    ...
    public final IUiSettingsDelegate getUiSettings() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            if (queryLocalInterface instanceof IUiSettingsDelegate) {
                iUiSettingsDelegate2 = (IUiSettingsDelegate) iInterface;
            } else {
                iUiSettingsDelegate2 = iUiSettingsDelegate;
                new zzbx(iBinder);
            }
        }
        IUiSettingsDelegate iUiSettingsDelegate3 = iUiSettingsDelegate2;
        parcel.recycle();
        return iUiSettingsDelegate3;
    }

    public final IProjectionDelegate getProjection() throws RemoteException {
        IProjectionDelegate iProjectionDelegate;
        IProjectionDelegate iProjectionDelegate2;
        Parcel zza = zza(26, zza());
        Parcel parcel = zza;
        IBinder readStrongBinder = zza.readStrongBinder();
        IBinder iBinder = readStrongBinder;
        if (readStrongBinder == null) {
            iProjectionDelegate2 = null;
        } else {
            ...
            if (queryLocalInterface instanceof IProjectionDelegate) {
                iProjectionDelegate2 = (IProjectionDelegate) iInterface;
            } else {
                iProjectionDelegate2 = iProjectionDelegate;
                new zzbr(iBinder);
            }
        }
        IProjectionDelegate iProjectionDelegate3 = iProjectionDelegate2;
        parcel.recycle();
        return iProjectionDelegate3;
    }
