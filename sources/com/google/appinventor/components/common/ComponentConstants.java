...
public class ComponentConstants {
    ...
    public static final String DEFAULT_POLLFISH_MODE = "Single Survey";
    ...
    public static final String DEFAULT_PRIMARY_TEXT_COLOR = "&HFF212121";
    public static final String DEFAULT_PROGRESSBAR_ANIMATION = "Wave";
    public static final int DEFAULT_ROW_COLUMN = -1;
    public static final String DEFAULT_SECONDARY_TEXT_COLOR = "&HFF757575";
    public static final String DEFAULT_THEME = "AppTheme";
    ...
    public static final int KODULAR_MIN_SDK = 19;
    public static final String KODULAR_PREF = "KODULAR_PREF";
    ...
    public static final int LISTVIEW_PREFERRED_WIDTH = 248;
    ...
    public static final String PROGRESS_DESCRIPTION = "Allows you to set animation style. Valid (case-insensitive) values are: ChasingDots, Circle, CubeGrid, DoubleBounce, FadingCircle, FoldingCube, Pulse, RotatingCircle, RotatingPlane, ThreeBounce, WanderingCubes, Wave. If invalid style is used, animation will be removed.";
    public static final String PROGRESS_DESCRIPTION_DESC = "Allows you to set animation style. Valid (case-insensitive) values are: ChasingDots, Circle, CubeGrid, DoubleBounce, FadingCircle, FoldingCube, Pulse, RotatingCircle, RotatingPlane, ThreeBounce, WanderingCubes, Wave. If invalid style is used, Wave animation will be used.";
